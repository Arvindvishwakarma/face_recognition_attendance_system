...
class Developer:
    def __init__(self, root):
        ...
        #developer info
        dev_label = Label(main_frame, text="Hello my name is Arvind Vishwakarma",font=("times new roman",12,"bold"),bg="white")
        dev_label.place(x=0,y=5)

        dev_label = Label(main_frame, text="I am a full stack developer",font=("times new roman",12,"bold"),bg="white")
